...
>
> 🕒 **執行時機（Steven 定：等 daydream 跑幾天）**：G 軸要有 before/after 數據
> 才有意義，需滿足 (a) operation 輪替跑滿 ≥1 個完整五日循環（7/8→7/12，
> 各 operation 至少 1 篇可比）、(b) SE 累積數次 self_assessment 才有趨勢。
> **最早合理執行日：2026-07-13 之後**（再多等一兩天讓 SE 趨勢更清楚更佳）。
> 執行前先確認 `Insights/` 有覆蓋 7/8–7/12 五種 operation 的檔。
